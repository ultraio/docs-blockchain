...
| meta_uris               | vector                      | Array           | no       | null                 | an array of base URIs pointing to the meta data of the token factory. e.g. Ultra.io/meta/1234, redundancy.ultra.io/meta/1234. If set, values cannot contain empty strings or duplicated values                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| meta_hash               | checksum256                 | string          | no       | null                 | meta data of token. Optional - can be signed with asset_creator key as proof of original if need                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
