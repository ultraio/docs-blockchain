import{_ as s,c as a,o as n,V as o}from"./chunks/framework.f1490fb9.js";const C=JSON.parse('{"title":"Example project with reveal","description":"","frontmatter":{},"headers":[],"relativePath":"guides/Uniq Variants/Examples/example-project.md","lastUpdated":1686237953000}'),l={name:"guides/Uniq Variants/Examples/example-project.md"},t=o(`<h1 id="example-project-with-reveal" tabindex="-1">Example project with reveal <a class="header-anchor" href="#example-project-with-reveal" aria-label="Permalink to &quot;Example project with reveal&quot;">​</a></h1><p>Let&#39;s create a minimalistic bored ape factory. It has to contain 3 metadata files and 3 jsons for factory, default token and uniq. For the sake of simplicity, we&#39;ll only fill the required fields for each metadata file. You can of course enrich uniqs, for example, by adding <code>attributes</code> to them. See <a href="./../uniq-metadata.html#metadata-fields">uniq metadata fields</a>.</p><p>Since this is a reveal scenario each uniq will be displayed as a question mark until it&#39;s minted. This is controlled by <code>default_token_uri</code> which acts as fallback in case there&#39;s no uri for a token.</p><p>Download the example project <a href="https://s3.us-east-1.wasabisys.com/ultraio-uniq-dev/example-pfp-project.zip" target="_blank" rel="noreferrer">here</a>.</p><h2 id="creating-a-bored-ape-factory" tabindex="-1">Creating a Bored Ape Factory <a class="header-anchor" href="#creating-a-bored-ape-factory" aria-label="Permalink to &quot;Creating a Bored Ape Factory&quot;">​</a></h2><div class="language-sh"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">cleos</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">push</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">action</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">eosio.nft.ft</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">create.b</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">[</span></span>
...
<span class="line"><span style="color:#C3E88D;">    &quot;memo&quot;: &quot;&quot;</span></span>
<span class="line"><span style="color:#C3E88D;">  }</span></span>
<span class="line"><span style="color:#C3E88D;">]</span><span style="color:#89DDFF;">&#39;</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-p</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">ultra.nft.ft</span></span></code></pre></div>`,9),e=[t];function p(c,r,i,u,q,y){return n(),a("div",null,e)}const D=s(l,[["render",p]]);export{C as __pageData,D as default};
